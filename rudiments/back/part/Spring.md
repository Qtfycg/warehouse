...
1.服务注册与发现/分布式配置管理
    1.Consul
        1.简介
            1.一套开源的分布式服务发现和配置管理系统。提供了微服务系统中的服务治理，配置中心，控制总线等功能。这些功能都可以根据需要单独使用。即Consul提供了一种完整的服务网络解决方案。
        2.功能
            1.服务注册与发现 
            2.健康监测
            3.KV存储
                ...
                2.新建配置文件
                    ...
                    2.服务器端
                        1.创建config文件夹，以/结尾
                        2.config文件夹下分别创建对应微服务配置的不同版本文件夹，以/结尾
                        3.上述文件夹下分别创建data内容 
                3.配置持久化 
                    1.consul_start.bat文件
            4.多数据中心
            5.可视化web界面
    2.Nacos
2.服务调用与负载均衡
    ...
    2.OpenFeign
        1.概念
            1.一个声明式web服务客户端，只需创建一个接口，并在该接口上添加注解@FeignClient即可
            2.自带负载均衡，基本上是当前微服务之间调用的事实标准
        2.使用步骤
            1.接口+@FeignClient 
3.分布式事务
    1.Seata
